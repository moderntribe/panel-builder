jQuery(function($) {
			...
			$( 'a#attachment_helper_library_button-' + count ).click( function(e) {
				...
				frame.on('select', function() {
					...
					if ( typeof (attachment.sizes[size].url ) != "undefined") {
						attachment_helper_load_image(attachment.sizes[size].url, count, size );
					} else {
						attachment_helper_load_image(attachment.url, count, size );
					}
	...
	function attachment_helper_load_image( url, count, size ) {
