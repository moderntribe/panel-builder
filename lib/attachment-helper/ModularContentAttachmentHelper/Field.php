...
class Field {
	...
	public function render() {
		...
		<div id="uploadContainer-<?php echo self::$count; ?>" style="margin-top: 10px;" class="attachment-helper-uploader">
				...
				<div id="uploaderSection-<?php echo self::$count; ?>">
					...
					<div id="plupload-upload-ui-<?php echo self::$count; ?>" class="hide-if-no-js">
						<div id="drag-drop-area-<?php echo self::$count; ?>">
							<div class="drag-drop-inside">
								...
								<p class="drag-drop-buttons">
									<a href="#" id="attachment_helper_library_button-<?php echo self::$count; ?>" class="button" title="Add Media" data-count="<?php echo self::$count; ?>">
