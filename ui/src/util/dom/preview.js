			...
			<div class="${styles.mask}">
				<header class="${styles.maskHeader}">
					...
					<button class="${styles.maskButton} ${styles.maskButtonUp}">
						<span data-tooltip class="${styles.tooltip}">
							<span class="${styles.maskScreenReader}">${UI_I18N['tooltip.panel_up']}</span>
						</span>
					</button>
					<button class="${styles.maskButton} ${styles.maskButtonDown}">
						<span data-tooltip class="${styles.tooltip}">
							<span class="${styles.maskScreenReader}">${UI_I18N['tooltip.panel_down']}</span>
						</span>
					</button>
					<button class="${styles.maskButton} ${styles.maskButtonDelete}">
						<span data-tooltip class="${styles.tooltip}">
							<span data-tooltip class="${styles.maskScreenReader}">${UI_I18N['tooltip.delete_panel']}</span>
						</span>
					</button>
				</header>
				<div class="${styles.maskTop} ${styles.maskAdd}">
					<button class="${styles.maskButtonAdd} ${styles.addPanelAbove}">
						<span data-tooltip class="${styles.tooltip}">
							<span data-tooltip class="${styles.maskScreenReader}">${UI_I18N['tooltip.add_above']}</span>
						</span>
					</button>
				</div>
				<div class="${styles.maskBottom} ${styles.maskAdd}">
					<button class="${styles.maskButtonAdd} ${styles.addPanelBelow}">
						<span data-tooltip class="${styles.tooltip}">
							<span data-tooltip class="${styles.maskScreenReader}">${UI_I18N['tooltip.add_below']}</span>
						</span>
					</button>
				</div>
			</div>
