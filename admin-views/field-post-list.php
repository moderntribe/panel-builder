...
?>
<div class="panel-input-group panel-input-post-list" id="<?php echo $id_string; ?>" data-name="<?php esc_attr_e($this->name); ?>" data-max="<?php echo $max; ?>" data-min="<?php echo $min; ?>" data-suggested="<?php echo $suggested; ?>">
				...
				<div class="selected-post">
					...
					<div class="select-post-input">
						<select class="post-type" data-filter_type="post_type">
							<option value=""><?php _e( 'Select Post Type', 'modular-content' ); ?></option>
						...
						<div class="post-picker">
							<input class="selected-post-field" type="hidden" data-placeholder="<?php esc_attr_e('Choose a Post', 'modular-content'); ?>" />
						</div>
					</div>
					...
					<div class="selected-post-toggle">
						...
						<a href="#" class="choose-manual-post button button-secondary"><?php _e( 'Create content', 'modular-content' ); ?></a>
					</div>
